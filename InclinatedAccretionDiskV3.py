...
"""
from numpy import sqrt,arctan,pi,linspace,zeros,exp,meshgrid,tan,arccos,cos,concatenate,tanh
...
Inclination = pi/3 #Inclinação do disco de acreção, em radianos
...
ListaParametros = concatenate((linspace(0,4,50),linspace(4.01,5.015,50), linspace(5.02,6.17,100), linspace(6.175,9,40), linspace(9.1,15,30)))
...
for b in ListaParametros:
    ...
    for theta in Angulos:
        ...
        #resolve o sistema
        sol = solve_ivp(F, [0, 150], [u0, y0, phi0], events=(EventHorizon, TF4, TF5, TF6), dense_output=True, max_step=0.5)
